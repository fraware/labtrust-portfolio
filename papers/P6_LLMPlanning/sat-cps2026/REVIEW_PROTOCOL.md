...
**Pass criterion:** Claims are bounded to containment and auditability; threat model is explicit; path-traversal failure is reported as first-class; no banned words (sufficient, comprehensive, guarantee, eliminate, state-of-the-art, unqualified robust).
...
**Pass criterion:** A reader can state the mechanism and point to a table or figure for each main claim; baseline section states what it does and does not prove.
