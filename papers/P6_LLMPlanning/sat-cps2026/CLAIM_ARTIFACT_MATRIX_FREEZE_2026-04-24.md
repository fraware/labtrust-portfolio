...
| `claims.yaml` | C2/C4 | `datasets/runs/llm_eval_camera_ready_20260424/denial_trace_stats.json` | yes | Denial stats artifact present. |
...
| `claims.yaml` | C3 | `datasets/p6_adaptive_suite.json` | yes | Adaptive suite corpus (JSON) present. |
...
| `claims.yaml` | C4 | `datasets/runs/llm_eval_camera_ready_20260424/e2e_denial_trace.json` | yes | E2E denial artifact present. |
...
| `claims.yaml` | C4 | `datasets/runs/llm_eval_camera_ready_20260424/baseline_benign.json` | yes | Benign baseline artifact present. |
