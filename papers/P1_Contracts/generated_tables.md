...
**Timestamp-only baseline:** denials with timestamp-only policy: 21. Violations the contract catches but timestamp-only would allow (missed): 13. Run contracts_eval.py with --baseline to populate.

## Ablation by failure class

| Class | Policy | Violations denied | Violations missed |
|-------|--------|--------------------|--------------------|
| control | full_contract | 0 | 0 |
| control | timestamp_only | 5 | -5 |
| control | ownership_only | 0 | 0 |
| control | accept_all | 0 | 0 |
...
**Detection metrics:** TP=34, FP=0, FN=0, precision=1.0, recall=1.0, F1=1.0.
