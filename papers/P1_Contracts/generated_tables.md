...
| control | occ_only | 3 | 0 |
| control | lease_only | 5 | -2 |
| control | lock_only | 5 | -2 |
...
| split_brain | lease_only | 8 | 9 |
| split_brain | lock_only | 9 | 8 |
...
| stale_write | occ_only | 7 | 0 |
| stale_write | lease_only | 0 | 7 |
...
| unknown_key | occ_only | 2 | 0 |
| unknown_key | lease_only | 2 | 0 |
| unknown_key | lock_only | 2 | 0 |
