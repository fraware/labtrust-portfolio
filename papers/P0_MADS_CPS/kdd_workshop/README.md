...
This folder is the workshop-facing packaging layer for P0 (MADS-CPS). It is built from canonical E1-E4 commands plus one new E5 model-evolution experiment.
...
- `artifacts/` - frozen manuscript-facing exports and E5 outputs

## Claim boundary

- Supported: replay-link verifiability (E3), baseline invariance and stressed divergence localization (E4), model-shift regression surfacing under fixed interface (E5).
