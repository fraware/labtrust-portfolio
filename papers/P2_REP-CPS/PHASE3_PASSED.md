...
- Overclaim: Conditional paper; trigger and scope stated in Limitations and docs/CONDITIONAL_TRIGGERS.md (P2).
- Repro block: Figure 0, Table 1/2/3, Figure 1 each have exact script commands.
