...
- Robust matrix (publishable): `scripts/run_assurance_robust_eval.py` writes `datasets/runs/assurance_eval/robust_results.json`. Full protocol and criteria: `docs/P7_ROBUST_EXPERIMENT_PLAN.md`.
