...
- Repro under 20 min: Minimal run documented (--seeds 3); publishable uses --seeds 20 --fault-mix; run manifest in heldout_results.json.
- Variance: Run manifest (seeds, scenarios) in heldout_results.json; 20 seeds for publishable tables.
