...
- **Repro:** Commands in `DRAFT.md` (Reproducibility + Appendix): `build_p0_conformance_corpus`, `export_e1_corpus_table`, `e2_redaction_demo`, `export_e2_admissibility_matrix`, `produce_p0_e3_release.py` / `replay_link_e3.py` with **`--runs 20 --scenarios toy_lab_v0,lab_profile_v0 --standalone-verifier`**, `run_p0_e4_multi_adapter.py` with matching seeds/scenarios, `export_p0_table3.py`; figures: `export_p0_assurance_pipeline`, `export_p0_tier_lattice`, `export_p0_redaction_figure`; optional `plot_e3_latency.py`; `generate_paper_artifacts.py --paper P0` for this file.
