...
**E4 (Algorithm-independence):** `python scripts/run_p0_e4_controller_matrix.py --seeds 20 --scenarios toy_lab_v0,lab_profile_v0 --regimes baseline,moderate,stress --out datasets/runs/p0_e4_controller_matrix.json`. Outputs include `datasets/runs/p0_e4_raw_summary.json`, `datasets/runs/p0_e4_normalized_summary.json`, `datasets/runs/p0_e4_per_seed.jsonl`, and `datasets/runs/p0_e4_diagnostics.json` (plus matrix JSON). Table 3: `python scripts/export_p0_table3.py --e3 datasets/runs/e3_summary.json --e4 datasets/runs/p0_e4_raw_summary.json` (prefers strong replay from E4 raw baseline rows and E3 strong replay when present).
