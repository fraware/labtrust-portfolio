...
- `scripts/export_bounded_review_packet.py --run-dir <run_dir> --out datasets/runs/assurance_eval_aies/bounded_review_packet --submission-mode`
...
- `tables/negative_failure_reasons.json`
