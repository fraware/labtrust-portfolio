...
|-------|--------------------|------------|-----------------|-----------------|
| P0 | `p0_conformance_corpus/`, e2_redaction_demo, e3_summary.json, p0_e4_raw_summary.json, p0_e4_normalized_summary.json, p0_e4_per_seed.jsonl, p0_e4_diagnostics.json, p0_e4_controller_matrix.json | `generate_paper_artifacts.py --paper P0` (runs E1–E4 exports) | export_p0_assurance_pipeline | export_p0_tier_lattice + plot_e3_latency |
