...
| P1 | contracts_eval/eval.json, scale_test.json, scale_sweep.json (optional), transport_parity.json | export_contracts_corpus_table (+ policy and ablation from eval) | export_p1_contract_flow | plot_contracts_scale |
| P2 | rep_cps_eval/summary.json | export_rep_cps_tables.py (Tables 1–7 from summary.json) | export_p2_rep_profile_diagram | plot_rep_cps_summary, plot_rep_cps_latency (Figure 2) |
| P3 | replay_eval/summary.json | export_replay_corpus_table.py; generated_tables.md (overhead + baselines from summary) | export_p3_replay_levels_diagram | plot_replay_overhead; verify_p3_replay_summary.py |
...
P2 tables are generated by `scripts/export_rep_cps_tables.py` from rep_cps_eval/summary.json. P3: Table 1 from `export_replay_corpus_table.py`; Tables 2–3 from `overhead_stats` and `baseline_overhead` in `replay_eval/summary.json` (documented in `papers/P3_Replay/generated_tables.md`); run `verify_p3_replay_summary.py` after regenerating the summary.
...
| P1 | `python scripts/contracts_eval.py --baseline` [optional: `--scale-test`, `--scale-sweep 1000,10000,100000`]; `python scripts/contracts_transport_parity.py` | `python scripts/export_contracts_corpus_table.py` | `python scripts/export_p1_contract_flow.py` | `python scripts/plot_contracts_scale.py` |
| P2 | `python scripts/rep_cps_eval.py --scenarios toy_lab_v0,lab_profile_v0` (default 20 seeds) | `python scripts/export_rep_cps_tables.py --summary datasets/runs/rep_cps_eval/summary.json` | `python scripts/export_p2_rep_profile_diagram.py` | `python scripts/plot_rep_cps_summary.py`, `python scripts/plot_rep_cps_latency.py` |
| P3 | `python scripts/replay_eval.py --out datasets/runs/replay_eval/summary.json --overhead-curve --overhead-runs 20 --thin-slice-seeds 42,43,44,45,46 --bootstrap-reps 500` | `python scripts/export_replay_corpus_table.py`; `papers/P3_Replay/generated_tables.md` | `python scripts/export_p3_replay_levels_diagram.py` | `python scripts/plot_replay_overhead.py`; `python scripts/verify_p3_replay_summary.py --strict-curve` |
