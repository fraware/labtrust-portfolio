...
|-------|--------------------|------------|-----------------|-----------------|
| P0 | `p0_conformance_corpus/`, e2_redaction_demo, e3_summary.json, p0_e4_raw_summary.json, p0_e4_normalized_summary.json, p0_e4_per_seed.jsonl, p0_e4_diagnostics.json, p0_e4_controller_pairs.jsonl, p0_e4_raw_failure_reasons.json, p0_e4_controller_matrix.json | `generate_paper_artifacts.py --paper P0` (runs E1–E4 exports) | export_p0_assurance_pipeline | export_p0_tier_lattice + plot_e3_latency |
...
| P6 | llm_eval_camera_ready_20260424/red_team_results (real_llm/real_llm_models, run_manifest, attribution, cross_model_summary), adapter_latency (optional latency_decomposition), baseline_comparison, baseline_comparison_args, baseline_benign, denial_trace_stats, replay_denials, mock_execution_harness | export_llm_redteam_table (Table 1, Table 1b), export_p6_baseline_table (3-way; --baseline-file for args/benign), export_p6_artifact_hashes, export_p6_reproducibility_table, export_p6_layer_attribution, export_p6_failure_analysis, export_p6_cross_model_heatmap, export_p6_latency_decomposition | export_p6_firewall_flow | plot_llm_adapter_latency |
| P7 | assurance_eval/results.json, robust_results.json, negative_results.json (`generation`, `by_scenario`, `by_perturbation`, lift metrics; submission-mode path redaction); **AIES:** assurance_eval_aies/ (`baseline_summary.json`, `institutional_positive_summary.json`, `negative_summary.json`, `bounded_review_packet/`, `tables/`, `figures/`, `RUN_MANIFEST.json`) | export_assurance_tables; export_p7_negative_tables (Tables 4–6 + reject matrix + lift + latency + by-scenario + boundary + redacted manifest + generation metadata); `papers/P7_StandardsMapping/generated_tables.md` (index); **AIES:** export_bounded_review_packet + export_aies_assurance_tables | export_p7_mapping_flow; `docs/figures/p7_review_stages.mmd` (Figure 2); **AIES:** export_aies_review_packet_figure | export_assurance_gsn (Figure 1) |
...
|-------|------------------|---------------|----------|----------|
| P0 | `python scripts/build_p0_conformance_corpus.py --out datasets/runs/p0_conformance_corpus`; `python scripts/e2_redaction_demo.py --out datasets/runs/e2_redaction_demo`; `python scripts/produce_p0_e3_release.py --runs 20 --scenarios toy_lab_v0,lab_profile_v0 --standalone-verifier`; `python scripts/run_p0_e4_controller_matrix.py --seeds 20 --scenarios toy_lab_v0,lab_profile_v0,rep_cps_scheduling_v0 --regimes baseline,moderate,stress,coordination_shock --out datasets/runs/p0_e4_controller_matrix.json` | `python scripts/generate_paper_artifacts.py --paper P0`; focused: `python scripts/export_p0_e4_controller_divergence_table.py`, `python scripts/export_p0_e4_claim_matrix.py` | `python scripts/export_p0_assurance_pipeline.py` | `python scripts/export_p0_tier_lattice.py`; `python scripts/plot_e3_latency.py` |
...
| P7 | `run_assurance_eval.py`; `run_assurance_robust_eval.py` (20 seeds); `run_assurance_negative_eval.py --submission-mode`; **AIES:** `run_assurance_eval.py --out datasets/runs/assurance_eval_aies` + `run_assurance_negative_eval.py --out datasets/runs/assurance_eval_aies --submission-mode` | `export_assurance_tables.py`; `export_p7_negative_tables.py --submission-mode`; **AIES:** `export_bounded_review_packet.py --submission-mode`, `export_aies_assurance_tables.py` | `export_p7_mapping_flow.py`; hand-maintained `docs/figures/p7_review_stages.mmd`; optional `render_p7_mermaid_figures.py`; **AIES:** `export_aies_review_packet_figure.py` | `export_assurance_gsn.py`; optional `render_p7_mermaid_figures.py` |
