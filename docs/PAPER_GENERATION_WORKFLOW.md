...
| P7 | assurance_eval/results.json, robust_results.json, negative_results.json (`generation`, `by_scenario`, `by_perturbation`, lift metrics; submission-mode path redaction) | export_assurance_tables; export_p7_negative_tables (Tables 4–6 + reject matrix + lift + latency + by-scenario + boundary + redacted manifest + generation metadata); `papers/P7_StandardsMapping/generated_tables.md` (index) | export_p7_mapping_flow; `docs/figures/p7_review_stages.mmd` (Figure 2) | export_assurance_gsn (Figure 1) |
...
| P7 | `run_assurance_eval.py`; `run_assurance_robust_eval.py` (20 seeds); `run_assurance_negative_eval.py --submission-mode` | `export_assurance_tables.py`; `export_p7_negative_tables.py --submission-mode` | `export_p7_mapping_flow.py`; hand-maintained `docs/figures/p7_review_stages.mmd`; optional `render_p7_mermaid_figures.py` | `export_assurance_gsn.py`; optional `render_p7_mermaid_figures.py` |
