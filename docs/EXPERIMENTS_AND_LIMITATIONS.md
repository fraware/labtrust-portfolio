...
- **Key results / presentable numbers:** P5, P6, P8 DRAFTs include a Key results subsection (Section 4 or 5) with concrete metrics; [RUN_RESULTS_SUMMARY.md](../datasets/runs/RUN_RESULTS_SUMMARY.md) gives a consolidated snapshot; `python scripts/export_key_results_p5_p6_p8.py` exports a markdown Key results block from the latest run artifacts for camera-ready drafts. See [EVALS_RUNBOOK.md](EVALS_RUNBOOK.md) (Camera-ready / key numbers).
