...
- **No real LLM:** P6 uses only synthetic plans; red-team is static cases.
...
11. **P6 Red-team and confusable deputy**
    - In [impl/src/labtrust_portfolio/llm_planning.py](../impl/src/labtrust_portfolio/llm_planning.py): add 2–3 red-team cases (e.g. allowed tool with disallowed args, boundary tool name) and 1–2 confusable deputy cases. Ensure llm_redteam_eval and DRAFT state the total count and that all are listed in the artifact.
