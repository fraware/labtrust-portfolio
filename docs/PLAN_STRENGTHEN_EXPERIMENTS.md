...
10. **P3 Replay corpus**
    - Add 1–2 replay corpus traces (e.g. different divergence types or event counts) in [bench/replay/corpus/](../bench/replay/corpus/) with expected outcome; update replay_eval to load all and report divergence_localization_confidence over the full set.
