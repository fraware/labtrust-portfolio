...
def _align_maestro(maestro_path: Path) -> None:
    """Keep only MAESTRO_REPORT.v0.1 top-level fields and allowed metric keys (strip adapter extras)."""
    ...
    data["metrics"] = {k: v for k, v in metrics.items() if k in allowed_metrics}
