...
These five scenarios form the v0.1 benchmark set. For held-out evaluation and train/val/test usage, see P5 (scaling_heldout_eval), which uses a leave-one-scenario-out protocol.
